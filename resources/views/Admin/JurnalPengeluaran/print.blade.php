...
<body onload="window.print()">
    ...
    <center>
        <h1 class="font-medium">Laporan Pengeluaran</h1>
    </center>
    ...
    <table border="1" id="table1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($d->tanggal_Pengeluaran)->translatedFormat('d F Y') }}</td>
                <td>{{ $d->no_manifest }}</td>
                <td>{{ $d->deskripsi }}</td>
                <td align="center">{{ number_format($d->jumlah_Pengeluaran, 2) }}</td>
                <td>{{ $d->status }}</td>
            </tr>
            @endforeach
        </tbody>
