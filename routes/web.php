...
use App\Http\Controllers\Admin\LapSupirController;
...
use App\Http\Controllers\Admin\JurnalPemasukanController;
use App\Http\Controllers\Admin\JurnalPengeluaranController;
...
Route::middleware(['checkRoleUser:/tracking,menu'])->group(function () {
    //tracking
    Route::get('/admin/tracking', [TrackingController::class, 'index'])->name('tracking.index');
    Route::post('/admin/tracking/track', [TrackingController::class, 'track'])->name('tracking.track');
});
...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/jurnal_pemasukan,menu'])->group(function () {
        //jurnal pemasukan
        Route::get('/admin/jurnal_pemasukan', [JurnalPemasukanController::class, 'index'])->name('jurnal_pemasukan.index');
        Route::get('/admin/jurnal_pemasukan/show', [JurnalPemasukanController::class, 'show'])->name('jurnal_pemasukan.show');
        Route::post('/admin/jurnal_pemasukan/store', [JurnalPemasukanController::class, 'store'])->name('jurnal_pemasukan.store');
        Route::post('/admin/jurnal_pemasukan/update/{jurnalPemasukan}', [JurnalPemasukanController::class, 'update'])->name('jurnal_pemasukan.update');
        Route::delete('/admin/jurnal_pemasukan/delete/{jurnalPemasukan}', [JurnalPemasukanController::class, 'destroy'])->name('jurnal_pemasukan.delete');
        Route::get('/admin/jurnal_pemasukan/print', [JurnalPemasukanController::class, 'print'])->name('jurnal_pemasukan.print');
    });

    Route::middleware(['checkRoleUser:/jurnal_pengeluaran,menu'])->group(function () {
        //jurnal pengeluaran
            Route::get('/admin/jurnal_pengeluaran', [JurnalPengeluaranController::class, 'index'])->name('jurnal_pengeluaran.index');
            Route::get('/admin/jurnal_pengeluaran/show', [JurnalPengeluaranController::class, 'show'])->name('jurnal_pengeluaran.show');
            Route::post('/admin/jurnal_pengeluaran/store', [JurnalPengeluaranController::class, 'store'])->name('jurnal_pengeluaran.store');
            Route::post('/admin/jurnal_pengeluaran/update/{jurnalPengeluaran}', [JurnalPengeluaranController::class, 'update'])->name('jurnal_pengeluaran.update');
            Route::delete('/admin/jurnal_pengeluaran/delete/{jurnalPengeluaran}', [JurnalPengeluaranController::class, 'destroy'])->name('jurnal_pengeluaran.delete');
            Route::get('/admin/jurnal_pengeluaran/print', [JurnalPengeluaranController::class, 'print'])->name('jurnal_pengeluaran.print');
        });
        
        Route::middleware(['checkRoleUser:/armada,menu'])->group(function () {
            // armada
            Route::get('/admin/armada', [ArmadaController::class, 'index'])->name('armada.index');
            Route::get('/admin/armada/getArmada', [ArmadaController::class, 'getArmada'])->name('armada.getArmada');
            Route::post('/admin/armada/store', [ArmadaController::class, 'store'])->name('armada.store');
            Route::post('/admin/armada/update/{armada}', [ArmadaController::class, 'update'])->name('armada.update');
            Route::delete('/admin/armada/delete/{armada}', [ArmadaController::class, 'destroy'])->name('armada.delete');
        });
    ...
    Route::middleware(['checkRoleUser:/supir,menu'])->group(function () {
        // Supir
        Route::resource('/admin/supir', \App\Http\Controllers\Admin\SupirController::class);
        Route::get('/admin/supir/show/', [SupirController::class, 'show'])->name('supir.getsupir');
        Route::post('/admin/supir/proses_tambah/', [SupirController::class, 'proses_tambah'])->name('supir.store');
        Route::post('/admin/supir/proses_ubah/{supir}', [SupirController::class, 'proses_ubah']);
        Route::post('/admin/supir/proses_hapus/{supir}', [SupirController::class, 'proses_hapus']);
    });
    ...
    Route::middleware(['checkRoleUser:/lap-supir,submenu'])->group(function () {
        // Laporan Supir
        Route::resource('/admin/lap-supir', \App\Http\Controllers\Admin\LapSupirController::class);
        Route::get('/admin/lapsupir/print/', [LapSupirController::class, 'print'])->name('lap-supir.print');
        Route::get('/admin/lapsupir/pdf/', [LapSupirController::class, 'pdf'])->name('lap-supir.pdf');
        Route::get('/admin/lap-supir/show/', [LapSupirController::class, 'show'])->name('lap-supir.getlap-supir');
    });
